...
def calc_changes(pos, vel, force, time_step):
    ...
    """
    pos_final = pos + vel * time_step + 0.5 * force * time_step ** 2 ## x_0 + v_0t + 1/2*aT^2
...
def calc_total_force(vel):
    ...
    force_drag = drag_const * vel ** 2 ## Drag [drag_x, drag_y]
